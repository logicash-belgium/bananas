...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final customTheme = TextTheme(
      ...
      headline4: TextStyle(fontSize: 40.0, fontStyle: FontStyle.normal),
      bodyText2: TextStyle(fontSize: 14.0, fontFamily: 'Poiret Un'),);
    final textTheme = customTheme.apply(
    ...
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Bananas for Every Minion'),
    );
  }
}
